...
### 🔧 **Key Features**
- **Activity Table** - Shows backup/restore activities in real-time
- **Live Updates** - Auto-refreshes with WebSocket connections
- **Interactive Filtering** - Filter by type, category, state, search
- **Activity Details** - Click activities for detailed information
- **Restart Failed Jobs** - Can restart failed activities from web interface
...
### 🎯 **Use Cases**
- **Operations Teams** - Monitor backup jobs from browser instead of CLI
- **Remote Monitoring** - Check backup status from any device
- **Team Collaboration** - Multiple users can view same activity list
- **Quick Troubleshooting** - Restart failed jobs with one click

### 📊 **What It Shows**
- Running, completed, and failed backup activities
